...
function startSession()
{
    ...
    {
         swal({   title: "Notice", allowEscapeKey:true, allowOutsideClick:true,  text: "EMDR can be an intensive therapy and should be discussed with a medical professional before being attempted in any setting. For more information, visit the about page.",   type: "warning",  confirmButtonText: "I understand",   closeOnConfirm: true }, function(){    document.getElementById("site-wrapper").className = "animated fadeOut";
...
function countSeconds()
{
    ...
    else if(localStorage.getItem("userTime") == "num20")
    {
        if(countTime > 20 && sessionActive)
        {
            endSession();
        }
    }
...
function endSession()
{
   ...
   setTimeout(function(){document.getElementById("firstTitle").className = "session-option animated fadeInDown reveal-inline";
                        document.getElementById("secondTitle").className = "session-option animated fadeInDown reveal-inline";},700)
